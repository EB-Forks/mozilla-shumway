...
function runViewer() {
  ...
  function handlerOOP() {
    ...
    messageManager.addMessageListener('Shumway:running', (message) => {
      externalInterface = message.objects.externalInterface;
    });

    messageManager.addMessageListener('Shumway:message', (message) => {
    ...
    messageManager.addMessageListener('Shumway:enableDebug', (message) => {
      enableDebug();
    });
